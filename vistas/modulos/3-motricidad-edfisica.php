...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        3er. Año - Educación Física - Educación Física, Corporeidad y Motricidad
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">3er. Año - Educación Física - Educación Física, Corporeidad y Motricidad</li>
      </ol>
    </section>
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeMotricidad" nombreAlumno="'.$value["nombre"].'" tabla="tercero" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" periodo="'.$_SESSION['periodo'].'" tabla="tercero" area="motricidad" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="saberesMotricidad">Saberes</label>
                      <textarea class="form-control" cols="80" rows="6" id="saberesMotricidad" name="saberesMotricidad">
                  </textarea>
              </div>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" id="apreciaMotricidad" name="apreciaMotricidad">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control input-lg" type="number" name="asistenciaMotricidad" id="asistenciaMotricidad" placeholder="Ingresar asistencia (%)" required>
              ...
              <div class="form-group">          
                  <label for="observaMotricidad">Observaciones</label>
                      <textarea class="form-control" cols="80" rows="3" id="observaMotricidad" name="observaMotricidad">
                  </textarea>
              </div>
         ...
         <?php
              ...
              $editarInforme -> ctrEditarInformeMotricidad($tabla, $curso);
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="copiaSaberesMotricidad">Saberes</label>
                      <textarea class="form-control" cols="80" rows="6" id="copiaSaberesMotricidad" name="copiaSaberesMotricidad">
                  </textarea>
              </div>
