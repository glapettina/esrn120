...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        4er. Año - Educación Física - Educación Física y Culturas Corporales
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">4er. Año - Educación Física - Educación Física y Culturas Corporales</li>
      </ol>
    </section>
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeCulturas" nombreAlumno="'.$value["nombre"].'" tabla="cuarto" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" periodo="'.$_SESSION['periodo'].'" tabla="cuarto" area="culturas" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="saberesCulturas">Saberes</label>
                      <textarea class="form-control" cols="80" rows="6" id="saberesCulturas" name="saberesCulturas">
                  </textarea>
              </div>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" id="apreciaCulturas" name="apreciaCulturas">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control input-lg" type="number" name="asistenciaCulturas" id="asistenciaCulturas" placeholder="Ingresar asistencia (%)" required>
              ...
              <div class="form-group">          
                  <label for="observaCulturas">Observaciones</label>
                      <textarea class="form-control" cols="80" rows="3" id="observaCulturas" name="observaCulturas">
                  </textarea>
              </div>
         ...
         <?php
              ...
              $editarInforme -> ctrEditarInformeCulturas($tabla, $curso);
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="copiaSaberesCulturas">Saberes</label>
                      <textarea class="form-control" cols="80" rows="6" id="copiaSaberesCulturas" name="copiaSaberesCulturas">
                  </textarea>
              </div>
